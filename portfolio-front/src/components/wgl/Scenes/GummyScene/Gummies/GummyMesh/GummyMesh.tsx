import { MeshTranslucentMaterial } from "@/components/wgl/TempMaterials/MeshTranslucentMaterial/MeshTranslucentMaterial";
...
export const GummyMesh: FC<IGummyMesh> = ({
    ...
    const targetPosition = useNoisyMovement(position, {
        speed: 0.5,
        amplitude: 5,
    });
